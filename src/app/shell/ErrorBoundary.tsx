...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  override componentDidCatch(error: Error, info: ErrorInfo): void {
    console.error('Chatspace conversation map failed safely.', error, info.componentStack);
  }
      ...
      return (
        ...
        >
          ...
          <div className="grid gap-1">
            ...
            <span className="text-cs-muted">ChatGPT is still available. Reload the ChatGPT tab to restore the map.</span>
          </div>
        </section>
      );
    }
